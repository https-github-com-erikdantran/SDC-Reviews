...
const getReviews = `http://3.18.212.140:5000/reviews/?product_id=${product_id}&count=100`;
const getReviewData = `http://3.18.212.140:5000/reviews/meta/?product_id=${product_id}`;
